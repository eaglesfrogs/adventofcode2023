...
for piece in pieces:
    ...
    if len(supporting_pieces) == 1:
        piece_to_remove = supporting_pieces.pop()
        if piece_to_remove in all_supporting_pieces:
            all_supporting_pieces.remove(piece_to_remove)


print(len(all_supporting_pieces))
